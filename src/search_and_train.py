    ...
    for step in range(config["max_steps"]):
        ...
        if (
            ...
            tune.report(
                ...
                loss_r=loss_r,
                loss_r_adv=loss_r_adv,
                loss_r_reg=loss_r_reg,
                loss_d_tot=loss_d_tot,
                loss_d_mean=loss_d_mean,
                loss_d_real=loss_d_real,
                loss_d_refined=loss_d_refined,
                acc_d_real=acc_d_real,
                acc_d_refined=acc_d_refined,
            )
